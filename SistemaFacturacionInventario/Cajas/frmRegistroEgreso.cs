    ...
    public partial class frmRegistroEgreso : Form
    {
        ...
        private void btnEgreso_Click(object sender, EventArgs e)
        {
            if (Validaciones())
            {
                ...
                cajasEgresos.IdCaja = cajaNegocio.ObtenerCajaActual().IdCaja;
        ...
        private bool Validaciones()
        {
            ...
            decimal montoCaja = Caja.MontoFinal ?? Caja.MontoInicial;
            if (Caja != null && montoCaja < Convert.ToDecimal(txtMonto.Text))
            {
            ...
            else
            {
                ...
                var resultado = cajaNegocio.EditarMontoCaja(-totalEgreso, 0, Caja.IdCaja);
